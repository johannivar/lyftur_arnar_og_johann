...
public class TestSuite {
	...
	public static ElevatorScene startVisualization() {
		...
		new Thread(new Runnable() {
			...
			@Override
			public void run() {
				new LwjglApplication(new ElevatorGraphics(visualizationScene), "The Threaded Elevator Machine", 1200,
						560, false);
			}
		}).start();
	...
	/**
	 * Feel free to change the initScene and runScene functions for testing but they
	 * will be switched out for our own test suite during grading
	 */
